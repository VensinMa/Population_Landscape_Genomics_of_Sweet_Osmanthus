...
find /public1/guop/mawx/workspace/cultivar_snpcalling/fastq.gz/ -type f -name "*.fq.gz" -exec mv {} /public1/guop/mawx/workspace/cultivar_snpcalling/fastq.gz/raw_data \;
