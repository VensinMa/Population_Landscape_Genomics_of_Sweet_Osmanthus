...
ped2lfmm("C:/Users/mawenxin/Downloads/Linux_down/194samples_snp.nounanchor.renamed.filtered.vcftools.LD.pruned.plink.ped", 
         "194samples_filtered.LD.pruned.nounanchor.lfmm", force = TRUE)
######################  读入解释变量与响应变量  ###############################
## X Y 数据中样品顺序（行）要一致
## 读取环境数据 （解释变量）
...
str(X)
## 读取基因型数据（响应变量）
Y = fread("C:/Rstudio/RStudio/Workspace/GEA_2024/lfmm/194samples_filtered.LD.pruned.nounanchor.lfmm")
